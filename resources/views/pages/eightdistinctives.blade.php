...
@section('content')
    ...
    <div class="col-md-5  well" >
        <center><i class="material-icons">satellite</i></center>
    ...
    <div class="col-md-5 col-md-offset-1 well" >
        <center><i class="material-icons">volume_up</i></center>
    ...
    <div class="col-md-5 well">
        <center><i class="material-icons">cloud_upload</i></center>
    ...
    <div class="col-md-5 well" >
        <center><i class="material-icons">person_pin</i></center>
    ...
    <div class="col-md-5 col-md-offset-1 well" >
        <center><i class="material-icons">navigation</i></center>
