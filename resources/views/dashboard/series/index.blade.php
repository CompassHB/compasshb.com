...
<div class="Setting Box Box--Large Box--bright utility-flex">
  ...
  <div class="col-md-4" {!! ($i % 3) ? '' : 'style="clear: left"' !!}>
    <a href="{{ route('series.show', $item->slug) }}" style="background-image: url({{ $item->acf->series_image->url }}); background-size: cover; width: 200px; height: 125px; display: block; background-position: center center;"></a>
